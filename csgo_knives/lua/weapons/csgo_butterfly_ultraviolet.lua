...
SWEP.Skin 					= "models/csgo_knife/knife_butterfly_ultraviolet.vmt"
  ...
  tracedata.filter    = Attacker
    ...
    if DidHit then
        if HitEntity and IsValid( HitEntity ) then
            ...
            Damage = ( Altfire and (Backstab and 180 or 90) ) or ( Backstab and 90 ) or ( ( math.random(0,5) == 3 ) and 40 ) or 25
